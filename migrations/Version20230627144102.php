 ...
 */
final class Version20230627144102 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE slider ADD CONSTRAINT FK_CFC7100771F7E88B FOREIGN KEY (event_id) REFERENCES api_event (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
