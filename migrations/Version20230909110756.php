 ...
 */
final class Version20230909110756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE api_radio (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, ville VARCHAR(100) NOT NULL, flux_audio VARCHAR(200) NOT NULL, flux_txt VARCHAR(200) DEFAULT NULL, code_postal VARCHAR(6) NOT NULL, coordonnees VARCHAR(50) DEFAULT NULL, rayon INT DEFAULT NULL, is_default TINYINT(1) NOT NULL, image_url VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
